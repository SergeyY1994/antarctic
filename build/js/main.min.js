...
/* harmony import */ var _modules_stretching_background_on_main_block__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/stretching-background-on-main-block */ "./js/modules/stretching-background-on-main-block.js");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _stretching_background_on_main_block__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./stretching-background-on-main-block */ "./js/modules/stretching-background-on-main-block.js");
...
var mainHeaderNavigationList = document.querySelector('.main-header__container .main-navigation__list');
var mainHeaderLogoElement = document.querySelector('.main-header__logo');
var mobileMenuLinkNodeList = document.querySelectorAll('.main-navigation__link--mobile-menu');
var wrapperElement = document.querySelector('.wrapper');
var mainHeaderSourceElement = document.querySelector('.main-header__logo-link source');
if (navMain && navToggle && mainHeaderContainer && mainHeaderNavigationList && mainHeaderLogoElement && mainHeaderSourceElement && mobileMenuLinkNodeList && wrapperElement) {
  ...
  wrapperElement.addEventListener('click', function (evt) {
    if (evt.target === wrapperElement) {
      closeMobileMenu();
      Object(_stretching_background_on_main_block__WEBPACK_IMPORTED_MODULE_0__["changeMainBlockMargin"])();
    }
  });
  var _iterator = _createForOfIteratorHelper(mobileMenuLinkNodeList),
    _step;
  try {
...
/*!***********************************************************!*\
  !*** ./js/modules/stretching-background-on-main-block.js ***!
  \***********************************************************/
/*! exports provided: changeMainBlockMargin */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "changeMainBlockMargin", function() { return changeMainBlockMargin; });
function _createForOfIteratorHelper(o, allowArrayLike) { var it = typeof Symbol !== "undefined" && o[Symbol.iterator] || o["@@iterator"]; if (!it) { if (Array.isArray(o) || (it = _unsupportedIterableToArray(o)) || allowArrayLike && o && typeof o.length === "number") { if (it) o = it; var i = 0; var F = function F() {}; return { s: F, n: function n() { if (i >= o.length) return { done: true }; return { done: false, value: o[i++] }; }, e: function e(_e) { throw _e; }, f: F }; } throw new TypeError("Invalid attempt to iterate non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); } var normalCompletion = true, didErr = false, err; return { s: function s() { it = it.call(o); }, n: function n() { var step = it.next(); normalCompletion = step.done; return step; }, e: function e(_e2) { didErr = true; err = _e2; }, f: function f() { try { if (!normalCompletion && it.return != null) it.return(); } finally { if (didErr) throw err; } } }; }
function _unsupportedIterableToArray(o, minLen) { if (!o) return; if (typeof o === "string") return _arrayLikeToArray(o, minLen); var n = Object.prototype.toString.call(o).slice(8, -1); if (n === "Object" && o.constructor) n = o.constructor.name; if (n === "Map" || n === "Set") return Array.from(o); if (n === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return _arrayLikeToArray(o, minLen); }
function _arrayLikeToArray(arr, len) { if (len == null || len > arr.length) len = arr.length; for (var i = 0, arr2 = new Array(len); i < len; i++) { arr2[i] = arr[i]; } return arr2; }
var mainBlockElement = document.querySelector('.main-block');
var mainHeaderElement = document.querySelector('.main-header');
var mobileMenuLinkNodeList = document.querySelectorAll('.main-navigation__link--mobile-menu');
window.addEventListener('DOMContentLoaded', function () {
...
function changeMainBlockMargin() {
  if (mainBlockElement && mainHeaderElement) {
    mainBlockElement.style.marginTop = "-".concat(mainHeaderElement.offsetHeight, "px");
  }
}
